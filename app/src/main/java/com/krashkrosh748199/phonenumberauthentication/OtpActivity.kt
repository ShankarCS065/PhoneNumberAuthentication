package com.krashkrosh748199.phonenumberauthentication
        ...
        auth.signInWithCredential(credential)
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    Log.d("TAG","SingInWithPhoneAuthCredential:${task.exception.toString()} ")
    ...
    inner class EdittextWatcher(private val view: View):TextWatcher{
        ...
        override fun afterTextChanged(s: Editable?) {
            ...
            when(view.id){
                ...
                R.id.otpEditText2 -> if(text.length==1) inputOTP3.requestFocus()
                else if(text.isEmpty()) inputOTP1.requestFocus()
                R.id.otpEditText3 -> if(text.length==1) inputOTP4.requestFocus()
                else if(text.isEmpty()) inputOTP2.requestFocus()
                R.id.otpEditText4 -> if(text.length==1) inputOTP5.requestFocus()
                else if(text.isEmpty()) inputOTP3.requestFocus()
                R.id.otpEditText5 -> if(text.length==1) inputOTP6.requestFocus()
